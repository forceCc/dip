...
inverse_img = inverseFilter(imgBlur, HBlur, D0=100)
wiener_img = wienerFilter(imgBlur, HBlur, 1e-6)

inverse_img1 = inverseFilter(gaussian_img, HBlur, D0=100)
wiener_img1 = wienerFilter(gaussian_img, HBlur, 1e-6)
